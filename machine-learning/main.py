...
def main(args):
    ...
    # the rest of the methods are up to you!
        ...
        if args.method_name == "dummy_classifier":
            ...
            search_arg_vals = [0, 1, 2, 3]
            train_labels = train_regression_target
            search_arg_name = "ridge_regression_lmda"

        elif args.method_name == "logistic_regression":
            method_obj = LogisticRegression(lr=args.lr, max_iters=args.max_iters)
            search_arg_vals = [1e-6, 1e-5, 1e-4]
            search_arg_name = "lr"

        elif args.method_name == "knn":
            method_obj = KNN(knn_neighbours=args.knn_neighbours)
            search_arg_vals = [2, 3, 4]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--method_name', default="nn", type=str, help="knn / logistic_regression / nn")
    ...
    parser.add_argument('--pca_dimension', type=int, default=200, help="dimension for pca")
